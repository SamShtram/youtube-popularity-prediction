...
def prepare_features(df, target_col="views"):
    ...
    if df_num.empty:
        print(" No numeric columns found — skipping model training.")
        return None, None
    ...
    if X.empty:
        print(" No valid numeric feature columns — cannot train model.")
        return None, None
...
if X_scraped is None or y_scraped is None:
    exit()
...
if X_scraped_clean.empty:
    print(" No valid data after cleaning — cannot proceed.")
    exit()
